...
```{r setup, echo=FALSE}
# globally change our working directory for entire document to be the root folder of
# the project
knitr::opts_knit$set(root.dir = rprojroot::find_rstudio_root_file())
# globally options for all chunks
knitr::opts_chunk$set(result=FALSE, echo=FALSE, warning=FALSE, message=FALSE)
```
...
```{r fig3, echo=FALSE, message=FALSE, warning=FALSE, results=FALSE}
# library(tidyverse)
# library(BayesFactor)
# 
# #Read data
